...
int main(int argc, char* argv[]){
    ...
    posix_memalign(reinterpret_cast<void**>(&dF),64,4*n*sizeof(int));
...
//    double* sigmaInv = malloc(2*n*sizeof(double));
   ...
   // printf("%i %lf\n",bufferI[64],T[64]);
    //for(int i = 0; i < n/2; i+= 1024){
    //accumTest7(T,dX,dF,sigmaInv,buffer,n/20,m,400);
        //  accumTest4(T, dX, dF, sigmaInv, buffer, bufferI,1024, m,1024, m);
  // }
     accumTest4(T, dX, dF,sigmaInv, buffer,bufferI,n,m,1);
//    accumTest9(T,n);
